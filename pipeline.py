...
LUA_SHA1 = get_hash(os.path.join(CWD, 'uploadir.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'u':
                wget_args.extend(['--warc-header', 'uploader-u: '+item_value])
                wget_args.append('https://uploadir.com/u/'+item_value)
            else:
...
project = Project(
    title='Uploader',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/a/ac/Uploadir-icon.png" height="50px" title=""/>
        <h2>uploadir.com <span class="links"><a href="https://uploadir.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/uploadir/">Leaderboard</a></span></h2>
        <p>Archiving Uploadir.</p>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://{}/{}/multi={}/'
        .format(TRACKER_HOST, 'arkivertest2', MULTI_ITEM_SIZE),
        downloader, VERSION),
